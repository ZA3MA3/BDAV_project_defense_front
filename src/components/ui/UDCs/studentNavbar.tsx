...
//     setFormData({ ...formData, supervisor_id: professor.user_id });
//     setFilteredProfessors([]);
//   };
...
//       alert("Please select a professor as supervisor.");
//       return;
//     }
...
//           </div>
//           <div>
//             <label className="block">Search Professor</label>
//             <Input
//               type="text"
//               placeholder="Enter professor name or user number"
...
//                     <TableCell>{prof.user_number}</TableCell>
//                     <TableCell>
//                       <Button onClick={() => handleSelectProfessor(prof)}>Select</Button>
//                     </TableCell>
//                   </TableRow>
//                 ))}
//               </TableBody>
...
//               <strong>Selected Supervisor:</strong> {selectedProfessor.name} (#{selectedProfessor.user_number})
//             </div>
//           )}
...
//       setSelectedProfessor(professor);
//       setFormData({ ...formData, supervisor_id: professor.user_id });
//       setFilteredProfessors([]); // Clear search results
//     };
...
//       <>
//         {/* Open Dialog Button */}
//         <Button variant="outline" onClick={() => setIsOpen(true)}>Add Project</Button>
...
//       description: "",
//       supervisor_id: null,
//       student_id: null,     // Assume you get this from props/context
//       teammate_id: null,
//     });
...
//                   type="text"
//                   placeholder="Enter professor name or user number"
//                   onChange={(e) => handleSearchProfessors(e.target.value)}
//                 />
//               </div>
//               {filteredProfessors.length > 0 && (
//                 <Table>
...
//                         <TableCell>
//                           <Button onClick={() => handleSelectStudent(stud)}>Select</Button>
//                         </TableCell>
//                       </TableRow>
//                     ))}
//                   </TableBody>
...
//                   <strong>Selected Teammate:</strong> {selectedStudent.name} (#{selectedStudent.user_number})
//                 </div>
//               )}
...
//                         <TableCell>{prof.user_number}</TableCell>
//                         <TableCell>
//                           <Button onClick={() => handleSelectProfessor(prof)}>
//                             Select
//                           </Button>
//                         </TableCell>
//                       </TableRow>
